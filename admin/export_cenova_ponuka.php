<?php
session_start();		
if(!$_POST["poslat_html_x"] or !$_POST['ID_cenovej_ponuky']){echo 'Spustite index_cenova_ponuka.php'; exit;} // spusti sa len pri kliknuti na Poslat mailom
include "config.php"; 
include "lib.php";
$poslat_html=$_POST["poslat_html_x"]; 
...
<table class="zoznam" border="1" align="center" cellpadding="10" cellspacing="10">
	...
	<tr><td colspan="2"><br></td></tr>
	<tr><td colspan="2">
		<table class="zoznam" style="width:100%" border="1" align="center" cellpadding="3" cellspacing="0">
	...
	while ($riadok2 = mysqli_fetch_assoc($vysledok2)) {
		...
		$sablona.='
		<tr><td>'.$popis_sluzby.'</td><td style="text-align:right!important;margin-right:20px">'.$Cena_za_jednotku[$i].'</td><td style="text-align:left!important;margin-right:3px" >'.$Pocet_kusov[$i].'</td><td style="text-align:right!important;margin-right:3px">'.$Cena_za_sluzbu[$i].'</td></tr>';
	}
	$sablona.='</table>
		</td></tr>
		<tr><td>Celková cena v € s DPH:</td><td>'.$Celkova_cena_s_DPH.'</br></td></tr>
		<tr><td colspan="2"><br></td></tr>
...
$filename = 'Cenová_ponuka_číslo_'.$ID_cenovej_ponuky.'.html';
